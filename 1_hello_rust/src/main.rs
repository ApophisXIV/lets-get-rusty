...
//Borrow checker   -> Rust internally uses something called borrow checker.
//                    Its similar to a garbage collector buts it guarantee the immutability
//                    In an advance context, its prevents race conditions.
//                    TODO: Investigate more about that